-- Prisma migration created from local schema without DB connection
-- To apply in Supabase, you can paste this in SQL editor or run `npx prisma db push` locally with DIRECT_URL configured.
